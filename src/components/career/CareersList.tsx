...
interface CareersListProps {
  initialCareers: CareerProfile[];
  categories: string[];
}

export function CareersList({ initialCareers, categories }: CareersListProps) {
  ...
  const filteredCareers = initialCareers.filter(career => {
    ...
    // Simple salary filter logic: checks if max salary is above the slider value
